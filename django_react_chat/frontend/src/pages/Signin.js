...
function SignIn(props) {
  ...
  const store_forgot_password_clicked = useSelector(
    (state) => state.session.forgot_password_clicked
  );
  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ padding: "6% 0% 0% 0%", margin: "0px" }}
      >
          ...
          <Form onSubmit={(e) => handleSubmit(e, "login", "")}>
            ...
            <Form.Group>
              <div
                ...
                style={{ fontSize: "1.5rem", paddingBottom: "2%" }}
              >
                <b>Sign In</b>
              </div>
            </Form.Group>
            ...
            <Row style={{ margin: "0px", padding: "0% 0% 5% 0%" }}>
              <Col style={{ paddingTop: "8px" }}>
                <div
                  className="text-center"
                  style={{ fontSize: "0.9rem", paddingTop: "15px" }}
                >
                  Not a user yet ?
                  <Link style={{ textDecoration: "none" }} to="/signup">
                    <span
                      className="cursor_pointer"
                      style={{ color: "#0879FA", marginLeft: "5px" }}
                    >
                      Sign Up Here.
                    </span>
                  </Link>
