...
function Header(props) {
  ...
  const [isIncorrectCurrentPassword, setIsIncorrectCurrentPassword] = useState(
    false
  );
  const [
    inCorrectCurrentPasswordMsg,
  ...
  const session_notification_data = useSelector(
    (state) => state.session.notifications
  );
  ...
  const showNotifications = (event) => {
    let data =
      session_notification_data &&
      session_notification_data.map((item) => {
        if (item) {
          item["read"] = true;
          return item;
        }
  ...
  const initializeSocket = () => {
    waitForSocketConnection(() => {
      WebSocketInstance.fetchFriendRequests(curr_user_data.id);
    });
  ...
  const changePassword = () => {
    if (formValid(formErrors, passwordFormData, "password")) {
      ...
      axiosInstance
        .post("change_password/", post_data)
        .then((res) => {
          spinnerStop();
          if (res.data.ok) {
            console.log(`
  ...
  const handleChange = (e) => {
    ...
    if (tabKey == "change_password") {
      ...
      let new_password_confirm = document.getElementById("newPasswordConfirm")
        .value;
      if (
    ...
    switch (name) {
      case "currentPassword":
        ...
        if (passwordRegex.test(value)) {
          ...
          setFormErrors({
            ...formErrors,
            currentPassword: "password field is required",
          });
        } else {
          if (value.length > 0) {
            setFormErrors({
      ...
      case "newPassword":
        ...
        if (passwordRegex.test(value)) {
          ...
          setFormErrors({
            ...formErrors,
            newPassword: "password field is required",
          });
        } else {
          if (value.length > 0) {
            setFormErrors({
      ...
      case "newPasswordConfirm":
        ...
        if (value.length > 0 && value !== password) {
          ...
          setFormErrors({
            ...formErrors,
            newPasswordConfirm: "confirm password field is required",
          });
        } else {
          setIsIncorrectPassword(false);
          setFormErrors({ ...formErrors, newPasswordConfirm: "" });
  ...
  const validatePassword = () => {
    ...
    if (formValid(formErrors, passwordFormData, "currentPassword")) {
      ...
      axiosInstance
        .post("validate_password/", post_data)
        .then((res) => {
          spinnerStop();
          if (res.data.ok) {
        ...
        >
          ...
          >
            <Tab
              eventKey="password"
              title={
                <span style={{ color: tabKey === "password" ? "#007BFF" : "" }}>
                  <FaKey
                    style={{
                      marginBottom: "5px",
                      marginRight: "15px",
                      ...
                      <Row style={{ margin: "0px", padding: "0px" }}>
                        ...
                        >
                          <p
                            ...
                            style={{ color: "#0879FA", textDecoration: "none" }}
                            className="cursor-pointer forgot-password text-right"
                          >
                            Forgot password ?
                          </p>
                        </Col>
            ...
            <Tab
              ...
              title={
                <span
                  style={{
                    color: tabKey == "change_password" ? "#228B22" : "",
                  }}
                >
                  <FaUserShield
                    style={{
                ...
                <Col sm={12} xs={12} md={12} style={{ marginTop: "2%" }}>
                  <Form style={{ marginTop: "20px" }}>
                    ...
                    <Form.Group controlId="newPasswordConfirm">
                      ...
                      >
                        <Col sm={12} xs={12} md={12} style={{ padding: "0px" }}>
                          {formErrors.newPasswordConfirm.length > 0 &&
                            formErrors.newPassword.length <= 0 && (
                              <span className="float-left errorMessage">
                                {formErrors.newPasswordConfirm}
                              </span>
        ...
        <Modal.Footer>
          <Row style={{ padding: "0px", margin: "0px" }}>
            <Col
              ...
              xs={{
                span:
                  (tabKey === "password" && !isValidCurrentPassword) ||
                  (tabKey === "change_password" && isValidCurrentPassword)
                    ? 8
                    : 4,
              }}
              sm={{
            ...
            >
              {isValidCurrentPassword && tabKey === "password" ? (
                ...
                >
                  <FaUserShield
                    onClick={() => setTabKey("change_password")}
                    size="20px"
                    style={{
                      cursor: "pointer",
                      color: "#007BFF",
              ...
              <DropdownButton
                ...
                title={
                  <img
                    ...
                    src={
                      curr_user_data && curr_user_data.profile_picture
                        ? curr_user_data.profile_picture
              ...
              >
                <Dropdown.Item>
                  <span style={{ color: "black", textDecoration: "none" }}>
                    Username :{" "}
                    <b>{curr_user_data ? curr_user_data.username : "-"}</b>
                  </span>
                </Dropdown.Item>
                <Dropdown.Item>
                  <Link
